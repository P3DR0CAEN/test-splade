    ...
    <nav class="bg-white border-b border-gray-100">
            ...
            <div class="flex justify-between h-16">
                <div class="flex">
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        ...
                        <x-nav-link href="{{ route('articles') }}" :active="request()->routeIs(['articles', 'article.detail'])">
                            {{ __('Articles') }}
                        </x-nav-link>
                    </div>
                </div>
        ...
        <div v-bind:class="{'block': data.open, 'hidden': ! data.open }" class="sm:hidden">
            <div class="pt-2 pb-3 space-y-1">
                ...
                <x-responsive-nav-link href="{{ route('articles') }}" :active="request()->routeIs(['articles', 'article.detail'])">
                    {{ __('Articles') }}
                </x-responsive-nav-link>
            </div>
        </div>
